...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["user_type"]))){
        $user_type_err = "Please select User.";
    } else {
...
//connecting to azure vm using ssh
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            $param_user_type = (int) $user_type;
            //$sytemuser = trim($_POST["username"]);
           // $systempass = trim($_POST["password"]);
            //system( " sudo /usr/sbin/useradd -m -p `openssl passwd -1 $systempass` $systemuser");
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($user_type_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="radio" name="user_type"  value="3"> Student <br>
